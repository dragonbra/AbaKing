package com.fro.room_sunalarmcase.viewDrawer;
...
public class MboardView extends View {
    ...
    public MboardView(Context context, AttributeSet attrs){
        this(context,attrs,0);
    }
    public MboardView(Context context, AttributeSet attrs,int defStyleAttr){
        super(context,attrs,defStyleAttr);
        TypedArray a = context.obtainStyledAttributes( attrs, R.styleable.MboardView, defStyleAttr,0);
        mRadius = a.getDimensionPixelSize(R.styleable.MboardView_radius, dpToPx(80));
        mBigSliceCount = a.getInteger(R.styleable.MboardView_bigSliceCount, 5);
        mScaleCountInOneBigScale = a.getInteger(R.styleable.MboardView_sliceCountInOneBigSlice, 5);
